          ...
          child: SingleChildScrollView(
            ...
            child: Column(
              children: [
                ...
                if (user.experienceLevel != null || user.availability != null)
                  Wrap(
                    spacing: 12,
                    runSpacing: 8,
                    ...
                    children: [
                      if (user.experienceLevel != null)
                        _Badge(Icons.work_outline, user.experienceLevel!),
                      if (user.availability != null)
                        _Badge(Icons.event_available, user.availability!),
                    ],
                  ),
                const SizedBox(height: 24),
                ...
                _Section(
                  ...
                  child: user.skills.isEmpty
                      ...
                      : Wrap(
                          spacing: 8,
                          runSpacing: 8,
                          children: user.skills.map((s) => _Chip(s)).toList(),
                        ),
                ),
                const SizedBox(height: 16),
                  ...
                  child: Column(
                    children: [
                      _Toggle(
                        ...
                        user.hackathonMode,
                        (v) =>
                            auth.updateProfile(user.copyWith(hackathonMode: v)),
                      ),
                      _Toggle(
                        'Mentorship Mode',
                        Icons.school,
                        user.mentorshipMode,
                        (v) => auth.updateProfile(
                          user.copyWith(mentorshipMode: v),
                        ),
                      ),
                    ],
                  ),
        ...
        children: [
          ...
          Expanded(
            child: Text(
              ...
              style: TextStyle(
                fontSize: 14,
                color: value ? AppColors.textWhite : AppColors.textSecondary,
              ),
            ),
          ),
          Switch(
